			...
			<?php
				if ( $speakers->total() > 0 ) :
					while ( $speakers->fetch() ) :
						$speakerVideos = $speakers->field( 'speaker-videos' ); ?>
							...
							<div class="speaker-summary large-6 columns">
								<div class="row">
									...
									<div class="small-12 medium-8 large-8 columns">
										<h1><a class="full-bio-link" href="<?php echo get_the_permalink( $speakers->id() ); ?>"><?php echo get_the_title( $speakers->id() ); ?></a></h1>
													...
													foreach ($speakerVideos as $video) :
														...
														<li class="video-thumb">
															<a href="<?php echo get_permalink($video['ID']); ?>">
																...
																<p class="thumb-video-title small"><?php echo get_the_title($video['ID']); ?></p>
															</a>
														</li>
													<?php endforeach;
												}
